...
function scrollToBlock(obj = {}) {
    ...
    $("html,body").animate(
        {
            scrollTop:
                $(obj.block || ".drimclub-benefit").offset().top -
                (obj.offsetY || 0),
        },
        1000,
        function () {
...
$(document).ready(() => {
    ...
    $(".hamburger").click(function () {
        ...
        if ($(this).hasClass("is-active")) {
            ...
            setTimeout(() => {
                $(".header__mobile-menu").removeClass(
